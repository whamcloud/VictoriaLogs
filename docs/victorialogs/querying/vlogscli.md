...
```sh
curl -L -O https://github.com/VictoriaMetrics/VictoriaLogs/releases/download/v1.33.1/vlutils-linux-amd64-v1.33.1.tar.gz
tar xzf vlutils-linux-amd64-v1.33.1.tar.gz
./vlogscli-prod
```
