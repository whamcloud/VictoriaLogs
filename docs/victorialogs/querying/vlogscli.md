...
```sh
curl -L -O https://github.com/VictoriaMetrics/VictoriaLogs/releases/download/v1.34.0/vlutils-linux-amd64-v1.34.0.tar.gz
tar xzf vlutils-linux-amd64-v1.34.0.tar.gz
./vlogscli-prod
```
